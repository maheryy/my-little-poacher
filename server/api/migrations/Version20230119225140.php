...
final class Version20230119225140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE user_bid_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE bid (id INT NOT NULL, animal_id INT NOT NULL, seller_id INT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, initial_price INT NOT NULL, current_price INT NOT NULL, start_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, end_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status SMALLINT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE bid_log (id INT NOT NULL, bid_id INT NOT NULL, bidder_id INT NOT NULL, price INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN bid_log.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, bid_id INT NOT NULL, author_id INT NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_bid (id INT NOT NULL, bidder_id INT NOT NULL, bid_id INT NOT NULL, status VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A1E4D278BE40AFAE ON user_bid (bidder_id)');
        $this->addSql('CREATE INDEX IDX_A1E4D2784D9866B8 ON user_bid (bid_id)');
        ...
        $this->addSql('ALTER TABLE user_bid ADD CONSTRAINT FK_A1E4D278BE40AFAE FOREIGN KEY (bidder_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE user_bid ADD CONSTRAINT FK_A1E4D2784D9866B8 FOREIGN KEY (bid_id) REFERENCES bid (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE user_bid_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE user_bid DROP CONSTRAINT FK_A1E4D278BE40AFAE');
        $this->addSql('ALTER TABLE user_bid DROP CONSTRAINT FK_A1E4D2784D9866B8');
        ...
        $this->addSql('DROP TABLE user_bid');
